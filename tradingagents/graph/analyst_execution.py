...
ANALYST_NODE_SPECS: dict[str, AnalystNodeSpec] = {
    ...
    "hotmoney": AnalystNodeSpec(
        key="hotmoney",
        agent_node="Hotmoney Analyst",
        clear_node="Msg Clear Hotmoney",
        tool_node="tools_hotmoney",
        report_key="hotmoney_report",
    ),
    "unlock": AnalystNodeSpec(
        key="unlock",
        agent_node="Unlock Analyst",
        clear_node="Msg Clear Unlock",
        tool_node="tools_unlock",
        report_key="unlock_report",
    ),
}
