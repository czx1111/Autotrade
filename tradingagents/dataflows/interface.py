...
from .akshare_data import (
    ...
    get_prediction_markets_akshare,
    get_share_unlock_akshare,
    get_social_sentiment_akshare,
    get_stock_data_akshare,
    get_ashare_market_snapshot,
    get_macro_indicators_akshare,
)
...
TOOLS_CATEGORIES = {
    ...
    # A-share specific enrichment (optional, degrade gracefully)
    "ashare_enrichment": {
        "description": "A-share market microstructure data (northbound flow, margin, dragon-tiger)",
        "tools": [
            "get_northbound_flow",
            "get_margin_trading",
...
OPTIONAL_CATEGORIES = {"macro_data", "prediction_markets", "ashare_enrichment"}
...
VENDOR_METHODS = {
    ...
    "get_macro_indicators": {
        ...
        "akshare": get_macro_indicators_akshare,
    },
    # prediction_markets
    "get_prediction_markets": {
        "polymarket": get_polymarket_prediction_markets,
        "akshare": get_prediction_markets_akshare,
    },
    # A-share enrichment tools (registered as separate method keys)
    "get_northbound_flow": {
    ...
    "get_dragon_tiger_list": {
        "akshare": get_dragon_tiger_list_akshare,
    },
    "get_social_sentiment": {
        "akshare": get_social_sentiment_akshare,
    },
    "get_share_unlock": {
        "akshare": get_share_unlock_akshare,
    },
    "get_ashare_market_snapshot": {
        "akshare": get_ashare_market_snapshot,
    },
}
...
def get_category_for_method(method: str) -> str:
    ...
    for category, info in TOOLS_CATEGORIES.items():
        if method in info["tools"]:
            return category
    # A-share enrichment tools have no category — assign one dynamically
    if method in VENDOR_METHODS:
        return "ashare_enrichment"
