...
class DataflowsConfigIsolationTests(unittest.TestCase):
    ...
    def test_partial_nested_update_preserves_existing_defaults(self):
        ...
        self.assertEqual(fresh["data_vendors"]["technical_indicators"], defaults["technical_indicators"])
        self.assertEqual(fresh["data_vendors"]["fundamental_data"], defaults["fundamental_data"])
